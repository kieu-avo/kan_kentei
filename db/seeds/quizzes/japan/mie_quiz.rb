...
#---------問題1--------------------------------------------------------------------★
quiz1 = Quiz.create!(
  content: "①最近良いご縁がないので、三重出身の友人に相談したところ、三重の白鳥市に有名な縁結び神社をお勧めされました。今、その神社でお参りしています。さて、その神社の名前は何でしょう？",
  youtube_url: nil,
  image_url: nil,
  test_category: mie
)
...
QuizChoice.create!(
  content: "伊射波神社",
  correct_answer: true,
  explanation: "①鳥羽市には、女性の願いを叶えてくれるといわれる三柱の女神様がいます。\n
      ●縁結びの神様「かぶらこさん」（伊射波神社）\n
      ●女性特有の病や安産の神様「彦瀧さん」（彦瀧大明神）\n
      ●女性の願いなら一つは叶えてくれる神様「石神さん」（神明神社）\n
      の三女神様です。各神社とも歴史は古く、地元の女性たちから信仰を受けてきました。三女神すべてを巡るとご利益がさらに増すと言われていますが、３つの神社はそれぞれ離れた位置にあるため、全てを回るには１日がかりになることがあります。相差町「石神さん」付近には宿泊・食事等施設が充実しているため、石神さんを拠点に鳥羽三女神を巡るのがおすすめです！",
  image_url: nil,
  quiz: quiz1
)
...
#---------問題5--------------------------------------------------------------------★
quiz5 = Quiz.create!(
  content: "⑤2日目です。昨日は沢山動いて疲れたので、気づいたら13時間も寝ていました。ぐっすりでした！時刻は10:30でお腹が空いています。三重県津市一志町にある「とんかつ 馬の背」という美味しいトンカツ屋さんについて聞いたので、今からトンカツを食べに行きます。このお店の営業は他の店舗と少し違いがあります。それは何でしょう？",
  youtube_url: nil,
  image_url: nil,
  test_category: mie
)
...
QuizChoice.create!(
  content: "営業時間が短い",
  correct_answer: true,
  explanation: "⑤とにかくボリューミーで美味しくて地元民に愛されているお店です。大きなトンカツだけでなくご飯も1杯お代わり無料で、お持ち帰りもできます！営業時間は11:00～13:00なので、こちらに行かれる方は時間に余裕を持っていきましょう！　https://tabelog.com/mie/A2401/A240101/24000770/",
  image_url: nil,
  quiz: quiz5
)
