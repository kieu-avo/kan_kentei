...
#---------問題1--------------------------------------------------------------------★
quiz1 = Quiz.create!(
  content: "①友人の結婚式に参加するために兵庫に来ています。結婚式は昨日で、今日は帰りの夜行バスの時間まで兵庫を観光する予定です。昨日の結婚式で、友人が両親へ向けた感動的な手紙を読んだとき、大号泣しました。その影響でまだ目が腫れています。お昼から居酒屋でお酒を楽しんでいたところ、知らないお姉さんが心配そうに『大丈夫！？誰に泣かされたの！？』と声をかけてきました。昨日の出来事を話したら、何故か神戸牛を食べに行こうと誘われました。神戸牛はある牛の種類のお肉ですが、その牛の種類とはどれでしょう？",
  youtube_url: nil,
...
QuizChoice.create!(
  content: "但馬牛",
  correct_answer: true,
  explanation: "神戸の牛と思うかもしれませんが、実は但馬牛です。但馬牛の中で厳格な基準をクリアしたお肉は神戸牛と呼ばれて世に送り出されます。基準に満たしていないお肉は但馬牛として販売されます。神戸牛は日本で一番厳しい審査基準で、2009年に海外のメディアで世界で最も高価な9種類の食べ物として神戸牛がランクインしました。兵庫県民も「神戸牛激うまい」と感動しています。高いですが、一度は食べてみたいですよね！",
  image_url: nil,
  quiz: quiz1
)
...
#---------問題2--------------------------------------------------------------------★
quiz2 = Quiz.create!(
  content: "②神戸牛を食べたことがないので、お姉さんの誘いに乗りました。お姉さんは兵庫の人で、オリックスの大ファンです。「○○のファンでないと、自己主張がしづらい...」と悲しそうに話していました。さて、その○○のプロ野球チームはどこでしょうか？",
  youtube_url: nil,
  image_url: nil,
  test_category: hyougo
)
...
QuizChoice.create!(
  content: "阪神",
  correct_answer: true,
  explanation: "※あくまでも問題作成にご協力頂いた方の意見です。",
  image_url: nil,
  quiz: quiz2
)
...
QuizChoice.create!(
  content: "こーへん",
  correct_answer: true,
  explanation: "他に、何している？は、神戸弁で「何しとぉ？」ですが、大阪弁では「何しとん？」です。方言の違いは興味深いですね！",
  image_url: nil,
  quiz: quiz6
)
