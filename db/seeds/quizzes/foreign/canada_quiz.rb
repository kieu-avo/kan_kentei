...
#---------問題４-------------------------------------------------------------------
quiz4 = Quiz.create!(
  content: "④カナダ本土の東端に位置する港町ハリファックス（Halifax）にやって来ました。ここはある有名な映画と関連があります。その映画とはどれですか？",
  youtube_url: nil,
  image_url: nil,
  test_category: canada
)
...
#---------問題５-------------------------------------------------------------------
quiz5 = Quiz.create!(
  content: "⑤歩き疲れたのでカフェに来ましたが、通信障害でクレジットカードが使えず、現金で支払うことになりました。カナダに来て始めて現金を使いますが、硬貨のあることに驚いています。それは何でしょう？",
  youtube_url: nil,
  image_url: nil,
  test_category: canada
)
