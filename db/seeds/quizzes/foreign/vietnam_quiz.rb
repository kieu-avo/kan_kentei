...
#---------問題１--------------------------------------------------------------------
quiz1 = Quiz.create!(
  content: "①日本で友達になったベトナム人の友人に会うために、ベトナムの首都へ向かっています。初めてのベトナム旅行で少し緊張していますが、10年ぶりに友人に会えるのがとても楽しみです！さて、その首都はどこでしょうか？",
  youtube_url: nil,
  image_url: nil,
...
#---------問題２--------------------------------------------------------------------
quiz2 = Quiz.create!(
  content: "②無事に友人宅に到着しました。明日はその友達の誕生日なので、あるものをプレゼントしたらびっくりされました。その反応は嬉しいものではなく、ショックな反応でした。そのプレゼントとは何でしょう？",
  youtube_url: nil,
  image_url: nil,
  test_category: vietnam
)
...
QuizChoice.create!(
  content: "ハンカチ",
  correct_answer: true,
  explanation: "ベトナム語でハンカチ（khăn）は「困難（khó khăn）」と発音が似ています。このため、ハンカチを贈ることは、その人の未来の涙や苦しみを予見していると解釈されることがあり、喜ばれない場合があります。その他にも避けるべきプレゼントがあるため、ベトナム人への贈り物を選ぶ際には注意が必要です！",
  image_url: nil,
  quiz: quiz2
)
...
#---------問題３--------------------------------------------------------------------
quiz3 = Quiz.create!(
  content: "③その友達には生後3ヶ月の赤ちゃんがいます。とてもニコニコしていて可愛かったので、「かわいい〜」と言って赤ちゃんを褒めたら、友達から注意されました。これはなぜでしょうか？",
  youtube_url: nil,
  image_url: nil,
  test_category: vietnam
)
...
QuizChoice.create!(
  ...
  correct_answer: true,
  explanation: "ベトナムには、赤ちゃんを褒めるとその子が将来その通りにならないという迷信があります。そのため、褒めたいときは反対の言葉を使うことが一般的です。ベトナムの赤ちゃんを褒める時は緊張しますね...!",
  image_url: nil,
  quiz: quiz3
)
...
QuizChoice.create!(
  content: "頭は神聖な部位だから",
  correct_answer: true,
  explanation: "赤ちゃん以外に、その友達には4歳の子供がいます。とてもいい子なので頭を撫でました。そうしたらまた友達に注意されました！どうしてですか？",
  image_url: nil,
  quiz: quiz4
)
...
QuizChoice.create!(
  content: "パイナップル",
  correct_answer: true,
  explanation: "甘酸っぱい味わいの魚介スープで、「canh （スープー）chua（酸っぱい）」とよびます。一部の日本人には好まれない傾向があります。",
  image_url: nil,
  quiz: quiz5
)
...
QuizChoice.create!(
  content: "333",
  correct_answer: true,
  explanation: "⑧このビールは国内シェア率70％以上を誇る人気者です。読み方は「バーバーバー」です。ベトナム語では数字の3は「バー」と言います。333以外にもベトナムビールがあるので、興味がある方は現地で探してみてください！",
