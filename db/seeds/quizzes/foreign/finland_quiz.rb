...
#---------問題4--------------------------------------------------------------------★
quiz4 = Quiz.create!(
  content: "④■サンタさんのおすすめその③：「北欧雑貨を買うならあるブランドのものを買うべし（お土産にいいよ）」\nこのブランドは日本でも人気があります。そのブランドはなんでしょう？",
  youtube_url: nil,
  image_url: nil,
  test_category: finland
)
...
#---------問題5--------------------------------------------------------------------★
quiz5 = Quiz.create!(
  content: "⑤■サンタさんのおすすめその④：「疲れたら○○休憩をとるべし」\n この休憩はなんだと思いますか？",
  youtube_url: nil,
  image_url: nil,
  test_category: finland
)
...
#---------問題6--------------------------------------------------------------------★
quiz6 = Quiz.create!(
  content: "⑥■サンタさんのおすすめその⑤：「ある動物の肉を食べるべし」\n
          さて、その動物はなんでしょう？\n
          ヒント：「これだけは、サンタさんからおすすめされたくなかった....」という反応がヒントです。",
  youtube_url: nil,
  image_url: nil,
  test_category: finland
)
