...
#---------問題1--------------------------------------------------------------------★
quiz1 = Quiz.create!(
  content: "①首都アムステルダムに到着しました。早速これからオランダで生まれたある有名な画家の美術館に行きます。その画家は誰でしょうか？",
  youtube_url: nil,
  image_url: nil,
...
QuizChoice.create!(
  content: "ハイネケン",
  correct_answer: true,
  explanation: "ビール工場の見学ができたり、ゴッホとコラボしたビールボトルがありますので、気になった方はオランダに来たら是非立ち寄ってみてください。行かれる際は事前にチケットを購入した方がスムーズに入場できるのでお勧めです。",
...
QuizChoice.create!(
  content: "165",
  correct_answer: true,
  explanation: "約165の運河が流れていると言われています。クルージングしているお客さんに手を振ると振り返ってきますので、これも一つアムステルダムの散策時のお楽しみポイントです。みなさんもクルージングをしたら是非歩いている人に手を振ってみてください！",
  image_url: "https://kan-kentei-bucket.s3.ap-northeast-1.amazonaws.com/netherlands/q3_exp.jpeg",
  quiz: quiz3
)

#---------問題4--------------------------------------------------------------------★
quiz4 = Quiz.create!(
  content: "④明日は一日中何も予定がないので、とてもイケメンなホテルのスタッフにお勧めの場所を聞いたところ、日本でも人気があるキャラクターのミュージアムをお勧めされました。なので、明日はそのミュージアムに行くことにします。そのキャラクターとは何でしょう？",
  youtube_url: nil,
  image_url: nil,
  test_category: netherlands 
)
...
QuizChoice.create!(
  ...
  image_url: "https://kan-kentei-bucket.s3.ap-northeast-1.amazonaws.com/netherlands/q5_exp.jpeg",
  quiz: quiz5
)
...
QuizChoice.create!(
  ...
  correct_answer: true,
  explanation: "⑥キンデルダイク＝エルスハウトの風車群は世界遺産に登録されています。18世紀に建てられたこれら19基の風車のうち、現在も稼働しているのは数機だけですが、それが珍しいことです。風車の中は住居となっており、当時の生活を見ることができます。「Kinderdijk UNESCO Official」というアプリをダウンロードすると、歴史などを教えてくれます。周囲はのどかで平和で、ゆっくりとした時間を過ごすことができます！キンデルダイク以外にも風車を見られるところはあります。",
